    ...
    <div className={`markdown-content ${className}`}>
      <ReactMarkdown
        components={{
          ...
          p: (props: any) => <p className={`${isChat ? 'text-sm mb-3 leading-relaxed' : isSummary ? 'text-2xl md:text-3xl lg:text-4xl mb-12 last:mb-0 leading-[1.3] font-medium' : 'text-lg mb-6 leading-relaxed'}`} {...props} />,
