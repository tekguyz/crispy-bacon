    ...
    <section className="relative mb-24 group animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-10">
        ...
        <div className="flex flex-col">
            <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-on-surface-variant opacity-40 leading-none">Executive Summary</h3>
            {isDeepStrategist && <span className="text-[7px] font-mono font-black text-amber-600 uppercase tracking-widest mt-1">Deep Analysis</span>}
        </div>
      </div>
