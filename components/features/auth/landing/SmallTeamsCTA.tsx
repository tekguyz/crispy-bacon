        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-16">
          <div className="max-w-2xl space-y-10">
             <div className="inline-flex items-center gap-3 px-4 py-2 bg-surface/5 border border-surface/10 rounded-full">
                ...
                <span className="text-[10px] font-mono font-black uppercase tracking-[0.4em] text-surface opacity-80">Sync Protocol 001</span>
             </div>
             ...
             <div className="space-y-6">
                ...
                <p className="text-lg md:text-2xl font-medium opacity-50 font-serif leading-relaxed max-w-xl">
                  Centralize your squad's strategic knowledge. Optimized for agencies, research labs, and boutique consulting teams.
                </p>
             </div>

             <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                {[
                  { icon: ShieldCheck, label: 'Shared Vaults', detail: 'Cross-team research access' },
                  { icon: Activity, label: 'Velocity Logs', detail: 'Track team decision history' },
                  { icon: Database, label: 'Bulk Retention', detail: 'Unified permanent storage' },
                  { icon: Zap, label: 'API Bridge', detail: 'Custom workspace automation' },
                ].map((item, i) => (
          ...
          <div className="shrink-0 w-full lg:w-auto self-stretch flex flex-col justify-center">
            ...
            <p className="text-[8px] font-mono font-black text-center mt-6 opacity-30 uppercase tracking-[0.5em]">Enterprise Tier Handshake</p>
          </div>
        </div>
      </div>
    </div>
