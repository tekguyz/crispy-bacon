...
export const LandingHero: React.FC<any> = ({ onSignIn }) => {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center pt-32 pb-20 overflow-hidden bg-background bg-grain border-b border-outline-variant/10">
      {/* Dynamic Background Elements */}
      <div className="absolute inset-0 ledger-grid opacity-[0.04] pointer-events-none text-on-surface" />
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-surface-container-highest/50 blur-[120px] rounded-full pointer-events-none -translate-x-1/2 translate-y-1/4" />
      ...
      <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-10">
            ...
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-primary/20 bg-surface-container-low/50 backdrop-blur-md shadow-sm animate-fade-in cursor-default hover:border-primary/40 transition-colors">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
              </span>
              <span className="text-[10px] font-black uppercase tracking-[0.25em] text-primary">System Online</span>
            </div>
            ...
            <div className="space-y-4">
              <h1 className="text-6xl md:text-8xl xl:text-9xl font-display font-black tracking-tighter leading-[0.85] text-on-surface uppercase animate-slide-up">
                Noisy World. <br />
                <span className="text-primary">Clear Signal.</span>
              </h1>
              <p className="text-xl md:text-2xl font-serif font-medium text-on-surface-variant opacity-70 max-w-2xl leading-relaxed animate-slide-up [animation-delay:100ms]">
                The professional research assistant for high-performance leaders. 
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 pt-4 animate-slide-up [animation-delay:200ms]">
              <button 
                ...
                className="w-full sm:w-auto px-12 h-16 bg-primary text-on-primary rounded-2xl font-black text-[11px] uppercase tracking-[0.25em] shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] hover:scale-[1.02] hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)] active:scale-95 transition-all flex items-center justify-center gap-4 group"
              >
                Start Recording 
              ...
              <button 
                onClick={handleSignIn}
                className="flex items-center gap-3 text-[10px] font-black text-on-surface uppercase tracking-widest hover:text-primary transition-colors group"
              >
                <div className="w-10 h-10 rounded-full border border-outline-variant/30 flex items-center justify-center group-hover:border-primary/50 transition-colors bg-surface-container-low">
             ...
             <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                <div className="absolute inset-0 bg-surface-container-low rounded-[3rem] border border-outline-variant/10 shadow-2xl rotate-3 flex items-center justify-center overflow-hidden">
                   ...
                   <div className="relative z-10 flex flex-col items-center gap-6 p-8">
                      ...
                      <div className="flex gap-2">
                         <div className="w-1.5 h-8 bg-primary rounded-full animate-[music-bar_1s_ease-in-out_infinite]" />
                         <div className="w-1.5 h-12 bg-primary rounded-full animate-[music-bar_1.2s_ease-in-out_infinite]" />
                         <div className="w-1.5 h-6 bg-primary rounded-full animate-[music-bar_0.8s_ease-in-out_infinite]" />
                         <div className="w-1.5 h-10 bg-primary rounded-full animate-[music-bar_1.5s_ease-in-out_infinite]" />
                         <div className="w-1.5 h-7 bg-primary rounded-full animate-[music-bar_1.1s_ease-in-out_infinite]" />
                      </div>
                   </div>
                </div>
                ...
                <div className="absolute -bottom-8 -left-8 bg-surface-container border border-outline-variant/10 p-6 rounded-3xl shadow-xl -rotate-2 w-64 backdrop-blur-md">
                   <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-[9px] font-black uppercase tracking-widest text-on-surface">Insight Ready</span>
                   </div>
                ...
                {/* Floating Card 2 */}
                <div className="absolute -top-4 -right-4 bg-on-surface text-surface p-5 rounded-3xl shadow-xl rotate-6">
